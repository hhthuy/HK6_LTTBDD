package com.se.stringboothibernatecruddemo.rest;
...
import com.se.stringboothibernatecruddemo.dao.EmployeeDAO;
...
public class EmployeeRestController {
	...
	//add mapping for DELETE /employee/{employeeId} - delete empolyess
		...
		public String deteleEmployee(@PathVariable int employeeId) {
